...
import { listPublishedProjectsCursor } from "@/lib/db/queries/projects";
import { PAGE_INITIAL } from "@/lib/pagination";
import { PageBreadcrumb } from "@/components/page-breadcrumb";
import { ProjectsInfiniteList } from "@/app/projects/projects-infinite-list";
...
async function firstPage() {
  ...
  return listPublishedProjectsCursor({ limit: PAGE_INITIAL });
}
...
export default async function ProjectsPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-6xl px-6 pt-24 pb-24">
      ...
      <ProjectsInfiniteList initial={initial} />
    </main>
  );
}
