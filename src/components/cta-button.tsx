...
export function CtaButton({
  ...
  const inner =
    variant === "primary" ? (
      <>
        {/* Leading spacer mirrors the trailing arrow circle so the label centers in-flow. */}
