  ...
  return (
    ...
    >
      <ScrollReveal
        ...
        stagger={0.08}
      >
        <div className="relative overflow-hidden rounded-[calc(2rem-0.375rem)] bg-[var(--card)] px-8 py-12 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] sm:px-12 sm:py-16 md:px-16">
          {/* Warm corner glow */}
          <span
            aria-hidden
